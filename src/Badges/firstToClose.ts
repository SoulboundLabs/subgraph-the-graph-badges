...
export function processAllocationClosedForFirstToCloseBadge(event: AllocationClosed): void {
...
function _processAllocationClosed(subgraphDeploymentID: string, indexer: string, blockNumber: BigInt): void {
